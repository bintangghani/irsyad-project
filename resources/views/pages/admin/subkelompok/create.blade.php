...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('dashboard.subkelompok.index') }}">Sub Kelompok</a>
            </li>
        ...
        <div class="container-xxl py-4 px-0">
            <div class="card">
                <div class="card-header d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <a href="{{ route('dashboard.subkelompok.index') }}" class="btn btn-secondary">
                        <span class="d-none d-sm-inline-block">Kembali</span>
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('dashboard.subkelompok.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_kelompok" id="id_kelompok" class="form-select @error('id_kelompok') is-invalid @enderror" required>
                                <option value="">Pilih ID Kelompok</option>
