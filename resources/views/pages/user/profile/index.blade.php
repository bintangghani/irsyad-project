            ...
            <form action="{{ route('dashboard.user.updateProfile', ['id' => Auth::user()]) }}" method="POST"
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit" id="save-button"
                        class="px-6 py-2 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-500 hidden">Save Changes</button>
